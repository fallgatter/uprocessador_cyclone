...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../q_sys.sopcinfo
...
# The SOPC System ID 
# setting SOPC_SYSID is 4207856382
SOPC_SYSID_FLAG += --id=4207856382
ELF_PATCH_FLAG  += --id 4207856382

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x10024b8
SOPC_SYSID_FLAG += --sidp=0x10024b8
ELF_PATCH_FLAG  += --sidp 0x10024b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1763553718
SOPC_SYSID_FLAG += --timestamp=1763553718
ELF_PATCH_FLAG  += --timestamp 1763553718
...
# setting altera_eth_tse_driver_ucosii_iniche.autoneg_timeout is 2500

# CheckLink Timeout in milliseconds none 
# setting altera_eth_tse_driver_ucosii_iniche.checklink_timeout is 10000

# "No MDIO" Timeout in microseconds none 
# setting altera_eth_tse_driver_ucosii_iniche.nomdio_timeout is 1000000
