...
# | 
# +-----------------------------------
add_parameter CLOCK_RATE LONG 0
set_parameter_property CLOCK_RATE VISIBLE false
set_parameter_property CLOCK_RATE AFFECTS_GENERATION false
...
add_parameter FIXED_PRESCALE int 0
set_parameter_property FIXED_PRESCALE DISPLAY_NAME "Prescale value"
set_parameter_property FIXED_PRESCALE AFFECTS_GENERATION false
set_parameter_property FIXED_PRESCALE DERIVED true
set_parameter_property FIXED_PRESCALE HDL_PARAMETER true
...
proc elaborate {} {
	...
	set prescale 0
	if {$clock_rate > 0} {
		# Prescaler must be set to divide down to 5 * 2.5MHz
		set prescale [expr {($clock_rate / 12500000) - 1} ]
	}
	
	set_parameter_value FIXED_PRESCALE $prescale
}
