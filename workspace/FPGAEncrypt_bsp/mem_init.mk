...
# Memory: ext_epcq_flash
MEM_1 := ext_epcq_flash
$(MEM_1)_NAME := ext_epcq_flash
...
$(MEM_1)_HIERARCHICAL_PATH := ext_epcq_flash
$(MEM_1)_WIDTH := 32
...
.PHONY: ext_epcq_flash
ext_epcq_flash: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex

# Memory: onchip_ram
MEM_2 := q_sys_onchip_ram
...
$(MEM_2)_START := 0x07000800
$(MEM_2)_END := 0x07000fff
